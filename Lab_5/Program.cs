...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        var dwarfHandler = new SquadHandler("Гноми-карлики", dwarfSquad, mediator);
        ...
        Console.WriteLine();
        battleTextRenderer.RenderHeader("Підсумковий стан клану після бою");
